...
import dataservicios.com.ttauditalicorp.Model.Categoria;
...
public class Categorias extends Activity {
    ...
    private int store_id, rout_id, company_id , audit_id,user_id ;
    private int  score = 0  ;
...
//        btCategoria3 = (Button) findViewById(R.id.btCategoria3);
        ...
        List<Product> ls = db.getAllProducts();
        listaCategorias=db.getCategoryAllProducts();

        listaCategorias.size();
        for (int i=0; i<listaCategorias.size(); i++) {
            //System.out.println(listaCategorias.get(i));
            final int category_id = listaCategorias.get(i).getId();
            ...
            bt.setText(listaCategorias.get(i).getNombre().toUpperCase());

            int status = db.getCategoryStatus(category_id);
            if(status==1) {
                ...
                public void onClick(View v) {
                   ...
                   // argRuta.putInt("company_id", GlobalConstant.company_id);
                    ...
                    argRuta.putString("category_name",texto);
                            ...
                            //intent = new Intent("dataservicios.com.ttauditalicorp.PRESENCIAPRODUCTO");
...
//    }
    ...
    private void InsertAuditProduct() {
        ...
        try {
           ...
           // params.add(new BasicNameValuePair("poll_id", String.valueOf(store_id)));
            ...
            params.add(new BasicNameValuePair("status", String.valueOf("1")));
    ...
    @Override
    public void onBackPressed() {
        Toast.makeText(MyActivity, "Debe terminar la auditoría y finalizar", Toast.LENGTH_LONG).show();
//        super.onBackPressed();
//        this.finish();
//
//        overridePendingTransition(R.anim.anim_slide_in_right,R.anim.anim_slide_out_right);
